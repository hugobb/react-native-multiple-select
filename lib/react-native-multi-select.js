...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    tagContainerStyle: PropTypes.style,
    ...
    styleDropdownMenu: PropTypes.style,
    styleDropdownMenuSubsection: PropTypes.style,
    styleInputGroup: PropTypes.style,
    styleItemsContainer: PropTypes.style,
    styleListContainer: PropTypes.style,
    styleMainWrapper: PropTypes.style,
    styleRowList: PropTypes.style,
    styleSelectorContainer: PropTypes.style,
    styleTextDropdown: PropTypes.style,
    styleTextDropdownSelected: PropTypes.style,
    styleTextTag: PropTypes.style,
    styleIndicator: PropTypes.style,
